  ...
  return (
    <div className="userBadgeContainer-bg mx-auto text-center">
      <Row className="userBadgeContainer">
        <Col xs sm md lg={3}>
          <Button variant="info">
            Saved Posts <Badge variant="light">{userProfileDetails.savePosts}</Badge>
            <span className="sr-only">Save Posts</span>
          </Button>
        </Col>
        <Col xs sm md lg={3}>
          <Button variant="success">
            User posts  <Badge variant="light">{userProfileDetails.totalPosts}</Badge>
            <span className="sr-only">User posts </span>
          </Button>
        </Col>
        <Col xs sm md lg={3}>
          <Button variant="warning">
            Unread Forum Messages <Badge variant="light">{userProfileDetails.forumAlerts}</Badge>
            <span className="sr-only">Unread Forum Messages </span>
          </Button>
        </Col>
        <Col xs sm md lg={3}>
          <Button variant="primary">
            Unread Messages <Badge variant="light">{userProfileDetails.unreadMessages}</Badge>
